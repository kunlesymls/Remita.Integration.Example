...
namespace Remita.NetDemo.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult PayRemita(PayRemitaVm model)
        {
            ...
            //    var validate = RemitaTransaction.Validate(orderId); // this will hash and validate the orderId, ApiKey and MerchantId is optional
        ...
        //Get SubmiteRemita
        public ActionResult SubmitRemita(RemitaPostVm model)
        {
            return View(model);
        }
        ...
        public ActionResult ConfrimPayment(string RRR, string orderID)
        {
            ...
            //var validate = RemitaTransaction.Validate(orderID, ); // this will hash and validate the orderId, ApiKey and MerchantId are optional
        ...
        {
            //var validate = RemitaTransaction.ReQuery(rrr);
            //if (validate.Item1)
            //{
            //    var result = validate.Item2;
            //    if (result.Status.Equals("00") || result.Status.Equals("01"))
            ...
            //    }
            //    var hash = RemitaHash.HashRemitedRePost(rrr); // MerchantId and ApiKey will use default if not supplied
            //    var url = Url.Action("ConfrimPayment", "Home", new { },
            //                           protocol: Request.Url.Scheme);
